...
const (
	...
	STACK_IDX               = 0x100
	RAM_IDX                 = 0x200
	RAM_MIRROR_IDX          = 0x800
	LOWER_IO_REG_IDX        = 0x2000
	LOWER_IO_REG_MIRROR_IDX = 0x2008
	UPPER_IO_REG_IDX        = 0x4000
	EXPANSION_ROM_IDX       = 0x4020
	SRAM_IDX                = 0x4000
	PRG_ROM_LOWER_IDX       = 0x8000
	PRG_ROM_UPPER_IDX       = 0xc000
	RAM_SIZE                = 0x10000
)
